...
class _WorkoutScreenState extends State<WorkoutScreen> {
  ...
  Future<void> _checkInjuryStatus() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("https://repeatapp.site/repEatApi/get_profile.php?user_id=${widget.userId}"),
  ...
  Future<void> _checkIfUserHasPlan() async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://repeatapp.site/repEatApi/check_workout_plan.php"),
  ...
  Future<void> _fetchCompletedExercises() async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://repeatapp.site/repEatApi/get_completed_exercises.php"),
        body: jsonEncode({
  ...
  Future<void> _loadWorkoutPlan() async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://repeatapp.site/repEatApi/get_workout_plan.php"),
        body: {"user_id": widget.userId.toString()},
      ).timeout(const Duration(seconds: 10));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
  ...
  Future<void> _generateWorkoutPlan() async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://repeatapp.site/repEatApi/generate_workout.php"),
        body: {"user_id": widget.userId.toString()},
  ...
  Future<void> _updateProgressOnServer(int newWeekIndex, int newDayIndex) async {
    try {
      await http.post(
        Uri.parse("https://repeatapp.site/repEatApi/update_workout_progress.php"),
        body: {
