  ...
  Future<void> _fetchWorkouts() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.100.79/repEatApi/get_workout_history.php?user_id=${widget.userId}'),
      );
    ...
    try {
      ...
      if (_editingWorkoutId != null) {
        ...
        final response = await http.post(
          Uri.parse('http://192.168.100.79/repEatApi/update_note.php'),
        ...
        // Create new note
        final response = await http.post(
          Uri.parse('http://192.168.100.79/repEatApi/save_note.php'),
          headers: {'Content-Type': 'application/json'},
          body: json.encode({
  ...
  Future<void> _deleteWorkout(int workoutId) async {
    ...
    try {
      final response = await http.delete(
        Uri.parse('http://192.168.100.79/repEatApi/delete_workout.php?workout_id=$workoutId'),
      );
