...
class _GymPlannerScreenState extends State<GymPlannerScreen> {
  ...
  Future<void> _loadRecommendations() async {
    final response = await http.get(
        Uri.parse('https://repeatapp.site/repEatApi/get_onboarding_data.php?user_id=${widget.userId}')
    );
  ...
  Future<void> _fetchWorkouts() async {
    ...
    try {
      final url = Uri.parse('https://repeatapp.site/repEatApi/get_workouts.php?user_id=${widget.userId}');
  ...
  Future<void> _saveWorkout() async {
    ...
    try {
      ...
      final endpoint = _formMode == 'add'
          ? 'https://repeatapp.site/repEatApi/save_workout.php'
          : 'https://repeatapp.site/repEatApi/update_workout.php';
  ...
  Future<void> _toggleWorkoutCompletion(int workoutId, bool isCompleted) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://repeatapp.site/repEatApi/toggle_workout_completion.php'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({
  ...
  Future<void> _deleteWorkout(int workoutId) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://repeatapp.site/repEatApi/delete_workout.php'),
        headers: {'Content-Type': 'application/json'},
