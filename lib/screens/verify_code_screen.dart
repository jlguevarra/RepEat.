...
class _VerifyCodeScreenState extends State<VerifyCodeScreen> {
  ...
  Future<void> _verifyCode() async {
    ...
    final apiUrl = 'https://repeatapp.site/repEatApi/verify_code.php'; // Replace with your LAN IP
  ...
  Future<void> _resendCode() async {
    final resendUrl = 'https://repeatapp.site/repEatApi/forgot_password.php'; // Replace with your LAN IP
