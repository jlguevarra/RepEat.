...
class _MealPlanScreenState extends State<MealPlanScreen> {
  ...
  Future<void> initializeMealPlan() async {
    ...
    try {
      ...
      final userUrl = Uri.parse(
        'http://192.168.100.79/repEatApi/get_profile.php?user_id=${widget.userId}',
      );
      ...
      final mealPlanUrl = Uri.parse(
        'http://192.168.100.79/repEatApi/get_saved_meal_plan.php?user_id=${widget.userId}',
      );
  ...
  Future<void> _saveMealPlanToServer(dynamic mealPlanData) async {
    try {
      final url = Uri.parse('http://192.168.100.79/repEatApi/save_meal_plan.php');
