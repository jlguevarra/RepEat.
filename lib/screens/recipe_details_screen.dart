...
class _RecipeDetailsScreenState extends State<RecipeDetailsScreen> {
  ...
  Future<void> _checkIfFavorite() async {
    try {
      final url = Uri.parse(
        'https://repeatapp.site/repEatApi/get_favorites.php?user_id=${widget.userId}',
      );
  ...
  Future<void> _toggleFavorite() async {
    ...
    try {
      if (isFavorite) {
        ...
        final url = Uri.parse('https://repeatapp.site/repEatApi/remove_favorite.php');
        ...
        // Add to favorites
        final url = Uri.parse('https://repeatapp.site/repEatApi/add_favorite.php');
