...
class _RecipeDetailsScreenState extends State<RecipeDetailsScreen> {
  ...
  Future<void> _checkIfFavorite() async {
    try {
      final url = Uri.parse(
        'http://192.168.0.11/repEatApi/get_favorites.php?user_id=${widget.userId}',
      );
  ...
  Future<void> _toggleFavorite() async {
    ...
    try {
      if (isFavorite) {
        ...
        final url = Uri.parse('http://192.168.0.11/repEatApi/remove_favorite.php');
        ...
        // Add to favorites
        final url = Uri.parse('http://192.168.0.11/repEatApi/add_favorite.php');
