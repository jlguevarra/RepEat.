...
class _DietPreferenceScreenState extends State<DietPreferenceScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://192.168.100.76/repEatApi/get_profile.php?user_id=$userId'));
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.100.76/repEatApi/update_diet_allergies.php'),
        body: {
