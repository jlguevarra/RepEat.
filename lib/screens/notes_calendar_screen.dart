...
class _NotesCalendarScreenState extends State<NotesCalendarScreen> {
  ...
  Future<void> _fetchAllEvents() async {
    ...
    try {
      final responses = await Future.wait([
        http.get(Uri.parse('http://192.168.100.76/repEatApi/get_reminders.php?user_id=${widget.userId}')),
        http.get(Uri.parse('http://192.168.100.76/repEatApi/get_holidays.php')), // Assumes this file exists
      ]);
  ...
  Future<void> _saveReminder({int? id}) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.100.76/repEatApi/save_reminder.php'),
  ...
  Future<void> _deleteReminder(int id) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.100.76/repEatApi/delete_reminder.php'),
        headers: {'Content-Type': 'application/json'},
